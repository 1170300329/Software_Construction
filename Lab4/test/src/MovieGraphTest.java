...
public class MovieGraphTest {
	...
	public void testgetEdge() throws Exception {
		ConcreteGraph g=(ConcreteGraph) GraphFactory.createGraph("src/src/test.txt");
	...
	public void testInvalidInstructionException() {
		try {
			...
			ConcreteGraph g=(ConcreteGraph) GraphFactory.createGraph("src/src/testMovieGraph1.txt");
		}catch (Exception e) {
	...
	public void testAttrNumException() {
		try {
			@SuppressWarnings("unused")
			ConcreteGraph g=(ConcreteGraph) GraphFactory.createGraph("src/src/testMovieGraph2.txt");
		}catch (Exception e) {
	...
	public void testHEdgeVerNumException() {
		try {
			@SuppressWarnings("unused")
			ConcreteGraph g=(ConcreteGraph) GraphFactory.createGraph("src/src/testMovieGraph3.txt");
		}catch (Exception e) {
