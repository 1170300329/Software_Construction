...
public class ConcreteGraphTest {
	/**
	 * Test Strategy:use different input including as more as possible cases and exception to test the project 
	 * work well or not.Different cases are divided into several equal cases. 
	 */
	...
	public void testgetEdge() throws Exception {
		ConcreteGraph g=(ConcreteGraph) GraphFactory.createGraph("src/src/test3.txt");
	...
	public void testInvalidLabelException(){
		try {
			...
			ConcreteGraph g=(ConcreteGraph) GraphFactory.createGraph("src/src/testGraphPoet1.txt");
		...
		try {
			@SuppressWarnings("unused")
			ConcreteGraph g=(ConcreteGraph) GraphFactory.createGraph("src/src/testGraphPoet3.txt");
		...
		try {
			ConcreteGraph g=(ConcreteGraph) GraphFactory.createGraph("src/src/testGraphPoet4.txt");
			g.hashCode();
		} catch (Exception e) {
			assertTrue(e instanceof InvalidLabelException);
	...
	public void testVertexTypeException() {
		try {
			ConcreteGraph g=(ConcreteGraph) GraphFactory.createGraph("src/src/testGraphPoet2.txt");
			g.hashCode();
		} catch (Exception e) {
		...
		try {
			ConcreteGraph g=(ConcreteGraph) GraphFactory.createGraph("src/src/testGraphPoet6.txt");
			g.hashCode();
		} catch (Exception e) {
			assertTrue(e instanceof VertexTypeException);
			assertEquals("不匹配的节点类型：Person", e.getMessage());
	...
	public void testExistedVertexException() {
		try {
			ConcreteGraph g=(ConcreteGraph) GraphFactory.createGraph("src/src/testGraphPoet5.txt");
			g.hashCode();
		} catch (Exception e) {
	...
	public void testEdgeTypeException() {
		try {
			ConcreteGraph g=(ConcreteGraph) GraphFactory.createGraph("src/src/testGraphPoet7.txt");
			g.hashCode();
		} catch (Exception e) {
		...
		try {
			ConcreteGraph g=(ConcreteGraph) GraphFactory.createGraph("src/src/testGraphPoet8.txt");
			g.hashCode();
		} catch (Exception e) {
			assertTrue(e instanceof EdgeTypeException);
			assertEquals("不匹配的边类型：FriendTie", e.getMessage());
	...
	public void testExistedEdgeException() {
		try {
			ConcreteGraph g=(ConcreteGraph) GraphFactory.createGraph("src/src/testGraphPoet9.txt");
			g.hashCode();
		} catch (Exception e) {
	...
	public void testHEdgeVerNumException() throws Exception {
		...
		ConcreteGraph g=(ConcreteGraph) GraphFactory.createGraph("src/src/testGraphPoet10.txt");
		for(Edge e:g.edges()) {
	...
	public void testInvalidInstructionException() throws Exception {
		...
		try {
			ConcreteGraph g=(ConcreteGraph) GraphFactory.createGraph("src/src/testGraphPoet11.txt");
			g.hashCode();
		} catch (Exception e) {
	...
	public void testNonExistentVertexException() throws Exception {
		...
		try {
			ConcreteGraph g=(ConcreteGraph) GraphFactory.createGraph("src/src/testGraphPoet12.txt");
			g.hashCode();
		} catch (Exception e) {
	...
	public void testMismatchEdgeException(){
		...
		try {
			ConcreteGraph g=(ConcreteGraph) GraphFactory.createGraph("src/src/testGraphPoet13.txt");
			g.hashCode();
		} catch (Exception e) {
	...
	public void testWeightException(){
		...
		try {
			ConcreteGraph g=(ConcreteGraph) GraphFactory.createGraph("src/src/testGraphPoet14.txt");
			g.hashCode();
		} catch (Exception e) {
		...
		try {
			ConcreteGraph g=(ConcreteGraph) GraphFactory.createGraph("src/src/testGraphPoet15.txt");
			g.hashCode();
		} catch (Exception e) {
			assertTrue(e instanceof WeightException);
		...
		try {
			ConcreteGraph g=(ConcreteGraph) GraphFactory.createGraph("src/src/testGraphPoet16.txt");
			g.hashCode();
		} catch (Exception e) {
			assertTrue(e instanceof WeightException);
			assertEquals("带权边TR权值不是正整数", e.getMessage());
	...
	public void testMultiEdgeException() throws Exception{
		...
		ConcreteGraph g=(ConcreteGraph) GraphFactory.createGraph("src/src/testGraphPoet17.txt");
		assertEquals(4, g.getEdge().size());
	}
	...
	public void test() throws Exception{
		@SuppressWarnings("unused")
		ConcreteGraph g=(ConcreteGraph) GraphFactory.createGraph("src/src/testGraphPoet18.txt");
	}
}
