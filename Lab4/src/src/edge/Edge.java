...
public abstract class Edge implements Serializable{
	...
	// vertices represents the vertexs included in the edge,the label represents the label of the edge
	// the weight represents the weight of the edge
	// Representation invariant:
	// vertices shouldn't be null and the weight should be -1 or positive float number.
	// Safety from rep exposure:
	// all the fields are private,label and weight are immutable,the vertices was defensively copied when geted.
