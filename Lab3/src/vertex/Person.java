...
import mementomanager.PsonMemManager;
import statememento.PersonMemento;
...
public class Person extends Vertex{
	...
	// the sex represents the sex of the person,the age represents the age of the person
	// the state represents the state of a user,and the indegree represents how many persons are connected to the person.
	// Representation invariant:
	// the sex should be M/F,the age should be positive integer,the state should only
	...
	public String toString() {
		return "Person [label="+this.getLabel()+" sex=" + sex + ", age=" + age +" Indegree"+this.getIndegree()+"]";
	}
	/**
